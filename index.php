...
<body>
    ...
    <div class="container-fluid remove-vid-marg">
     ...
     <?php 
    include('C:\xampp\htdocs\Acadexa_A_Smart_Online_Learning_Management_System\view\contact.php');
    ?> 

      //Student feedbad ar ar jonno code korte hobw and kisu external css and js apply korte hobe
