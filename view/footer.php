...
<footer class="container-fluid bg-dark text-center p-2">
  <small class="text-white">
    ...
    <?php
      ...
      // } else {
      //   echo '<a href="#" data-toggle="modal" data-target="#adminLoginModalCenter"> Admin Login</a>';
      // }
    ?>
  </small>
</footer>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php include __DIR__ . '/student/studentRegistration.php'; ?>
      </div>
      <div class="modal-footer">
        <span id="successMsg"></span>
        <button type="button" class="btn btn-primary" id="stuSignupBtn" onclick="addStu()">Sign Up</button>
...
<!-- JS: Bootstrap 4 stack — use RELATIVE paths to avoid 404 -->
<script src="view/js/jquery.min.js"></script>
<script src="view/js/popper.min.js"></script>
<script src="view/js/bootstrap.min.js"></script>

<!-- Optional libs (keep only if these files actually exist under view/js) -->
<!-- Removed Font Awesome JS (not needed for basic icons) to avoid 404 -->
<script src="view/js/owl.min.js"></script>
<script src="view/js/testyslider.js"></script>

<!-- App JS -->
<script src="view/js/ajaxrequest.js"></script>
<script src="view/js/adminajaxrequest.js"></script>
<script src="view/js/custom.js"></script>

<!-- Simple presence check -->
<script>
  console.log('Modal present:', !!document.getElementById('stuRegModalCenter'));
</script>
